...
class bdAd_DevHelper_Config extends DevHelper_Config_Base
{
    protected $_dataClasses = array(
        'slot' => array(
            ...
            'files' => array(
                'data_writer' => array(
                    'className' => 'bdAd_DataWriter_Slot',
                    'hash' => '155c29741b511acdad7dad00a5617397'
                ),
                'model' => array('className' => 'bdAd_Model_Slot', 'hash' => '9f6f8d05c1c0985d959e2814570e47e6'),
                'route_prefix_admin' => array(
                    'className' => 'bdAd_Route_PrefixAdmin_Slot',
                    'hash' => '408c5f05b534888ca3c42ccbd940b8b5'
                ),
                'controller_admin' => array(
                    'className' => 'bdAd_ControllerAdmin_Slot',
                    'hash' => '96d35b57c63ac3168c806771dbc0dc86'
                ),
            ),
        ),
        'ad' => array(
            ...
            'files' => array(
                'data_writer' => array(
                    'className' => 'bdAd_DataWriter_Ad',
                    'hash' => 'x63fc8e26039ccddc42ff2376863982a1'
                ),
                'model' => array('className' => 'bdAd_Model_Ad', 'hash' => '579a907053d0f54bb18cb201dd4e7c39'),
                'route_prefix_admin' => array(
                    'className' => 'bdAd_Route_PrefixAdmin_Ad',
                    'hash' => '8793f07123e7fd29f0b2d3526914c271'
                ),
                'controller_admin' => array(
                    'className' => 'bdAd_ControllerAdmin_Ad',
                    'hash' => '4b2867a65111c16b876aa84fcbb34f49'
                ),
            ),
        ),
        'ad_slot' => array(
            ...
            'camelCaseWSpace' => 'Ad Slot',
            'camelCasePluralWSpace' => false,
            'fields' => array(
                'ad_id' => array('name' => 'ad_id', 'type' => 'uint', 'required' => true),
                'slot_id' => array('name' => 'slot_id', 'type' => 'uint', 'required' => true),
                'ad_slot_options' => array('name' => 'ad_slot_options', 'type' => 'serialized'),
            ),
            'phrases' => array(),
            'title_field' => false,
            'primaryKey' => array('ad_id', 'slot_id'),
            'indeces' => array(),
            'files' => array(
                'data_writer' => false,
                'model' => array('className' => 'bdAd_Model_AdSlot', 'hash' => '73e045f6dfdf5ba3f0f74238b6eaf6d5'),
